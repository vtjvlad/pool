...
export const POCKET_CAPTURE = 28;
export const POCKET_OPENING = 18;
export const POCKET_RECESS = 17;
export const SIDE_NOTCH_HALF = 26;
export const CORNER_JAW_ALONG = 32;
export const POCKET_MAGNET = 0.35;
