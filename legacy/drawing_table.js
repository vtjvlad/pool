/**
 * LEGACY — Canvas 2D отрисовка стола.
 * Заменён: public/render/drawing_table.js (CanvasKit + SkPicture).
 * Использовался: public/main.js → draw() → drawTable(ctx).
 * Удалён из main: getContext('2d'), прямой импорт.
